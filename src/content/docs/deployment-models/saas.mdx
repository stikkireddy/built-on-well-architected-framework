...
Workspace-catalog binding provides a mechanism for controlling which catalogs are accessible from which workspaces. This is an important consideration for both security and compliance.

For detailed information on configuring workspace-catalog binding, see the [Databricks documentation](https://docs.databricks.com/aws/en/catalogs/binding).
